...
class PurchaseOrderController extends Controller
{
    ...
    private function printWeaving(PurchaseOrder $order)
    {
        ...
        <tr>
            <td width="10%" style="border:0.75px solid #000;background-color:#f0f0f0;"><b>Fabric Quality</b></td>
            <td width="60%" style="border:0.75px solid #000;">' . e($quality) . '</td>
            <td width="10%" style="border:0.75px solid #000;background-color:#f0f0f0;"><b>P.O Quantity</b></td>
