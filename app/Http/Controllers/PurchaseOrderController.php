...
class PurchaseOrderController extends Controller
{
    ...
    private function printWeaving(PurchaseOrder $order)
    {
        ...
        <tr>
            ...
            <td width="83%" style="border:0.75px solid #000;">' . $order->greigeProduct->name . '</td>
        </tr>
        ...
        $totalCost = $order->warp_yarn_rate  + $order->weft_yarn_rate + $order->sizing_rate_per_meter + $order->warping + ($order->rate_per_pick*$order->pick);
            ...
            <td width="60%" style="vertical-align:top;">
                <table cellpadding="4" cellspacing="0" width="100%" style="border:0.75px solid #000; font-size:9px;">
                    ...
                    <tr>
                        ...
                        <td style="border:0.75px solid #000;">'. number_format($order->warp_yarn_rate, 2) * number_format($calc['warp_consumption'], 2). '</td>
