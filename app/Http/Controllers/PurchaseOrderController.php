...
$warpAmount = (float) $order->warp_yarn_cost_price
            * (float) $calc['warp_consumption']
            * (float) $order->total_meters_required;        $weftAmount = $order->weft_yarn_cost_price * $calc['weft_consumption'] * $order->total_meters_required;
